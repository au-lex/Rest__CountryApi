  ...
  return (
    <main className={`${isDarkMode ? 'darkmood' : ''} `}>
      <div className='bg1 h-[120] absolute right-0 left-0 top-0 z-30 pt-24'>
        <Link to={"/"} className='my-2 bg1  cursor-pointer py-2 sh ml-[1rem] block 
         w-[40%] text-center lg:w-[10%]'>back</Link>
        ...
        <figure className='pb-[2.8rem] bg1 mb-6 w-[100%]  px-[1.2rem] lg:my-[2rem] mt-[2rem] lg:flex lg:justify-around '>
         ...
         <section>
          ...
          <figcaption className='px-4 mb-[2rem] sh h-[20rem]'>
            
                <h1 className="ctryName bg capitalize text-[1.5rem] w-[80%] lg:w-[100%] font-bold mt-8">{country.name.common}</h1>
          ...
          <figcaption className='px-4 lg:pt-[4rem] h-[10rem] py-3  sh'>
